...
class Comment {
  ...
  Comment.fromJson(Map<String, dynamic> json) {
    ...
    profilePictureUrl = json['profile_picture_url'] !=null && !json['avatar'].contains("http") && json['profile_picture_url'].toString().length > 0 ? Helper.baseURL + json['profile_picture_url'] : null;
