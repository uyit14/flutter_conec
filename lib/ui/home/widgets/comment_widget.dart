...
class _CommentWidgetState extends State<CommentWidget> {
  ...
  void didChangeDependencies() {
    ...
    _likeCount = _itemDetail.likeCount;
  }
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ...
                  Spacer(),
                  Text('${_itemDetail.viewCount} lượt xem')
                ],
              ),
              Container(
                  ...
                  InkWell(
                    onTap: () {
                      if(!globals.isSigned){
                        ...
                        _itemsByCategoryBloc.requestLikePost(_itemDetail.postId);
                        if (!_isLikeOwner) {
                          _likeCount++;
                        } else {
                          _likeCount--;
                ...
                child: Row(
                  children: <Widget>[
                    !_isLoading
                        ? CircleAvatar(
                            radius: 25,
                      backgroundImage: _itemDetail.ownerAvatar !=
                          null
                          ? NetworkImage(
                          _itemDetail.ownerAvatar)
                          : AssetImage(
