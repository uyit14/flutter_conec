...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void doSignUp() {
    ...
    //
    _authenBloc.requestSignUp(_userNameController.text, _emailController.text,
      ...
      switch (event.status) {
        ...
        case Status.COMPLETED:
          ...
          Navigator.of(context)
              .pushNamed(ConfirmEmailPage.ROUTE_NAME, arguments: {
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  fontSize: Helper.getScreenHeight(context) >
                                          Helper.getScreenWidth(context)
