      ...
      _profileBloc.profileStream.listen((event) {
        switch(event.status){
          case Status.COMPLETED:
            ...
            setState(() {
              _name = profile.name ?? "";
              _address = '${profile.address}, ${profile.ward}, ${profile.district}, ${profile.province}' ?? "";
              ...
              Positioned(
                ...
                child: globals.isSigned
                  ...
                  children: <Widget>[
                    ...
                    Text(_address ?? "Chưa cập nhật địa chỉ",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 18,
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.of(context).pushNamed(DetailProfilePage.ROUTE_NAME);
                      },
